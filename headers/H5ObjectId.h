...
namespace HDF5DotNet
{
    ...
    public ref class H5ObjectId : public H5Id,
        H5ObjectWithAttributes
    {
    internal:
        /// <remarks>
        /// This is the only constructor used to create an H5ObjectId.
    ...
    private:
        ...
        /// routines are capable of creating an instance of H5ObjectId
